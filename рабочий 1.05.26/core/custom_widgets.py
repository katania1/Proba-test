...
class VibeTextEdit(QTextEdit):
    ...
    def __init__(self, parent=None):
        ...
        self.project_path = "" # Сюда главное окно передает путь проекта
