...
class VibeDragButton(QPushButton):
    """
    Гибридная кнопка отправки v4.0 (Абсолютная изоляция).
    """
    ...
    def start_vibe_drag(self):
        ...
        # 4. РАЗДЕЛЕНИЕ: В БУФЕР ИДЕТ ТОЛЬКО КОРОТКИЙ ТЕКСТ ПОЛЬЗОВАТЕЛЯ
        ...
        # Б) Любые прикрепленные файлы (код, текстовики)
